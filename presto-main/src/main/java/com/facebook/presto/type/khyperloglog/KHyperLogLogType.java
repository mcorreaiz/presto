...
public class KHyperLogLogType
        extends AbstractVariableWidthType
{
    public static final KHyperLogLogType K_HYPER_LOG_LOG = new KHyperLogLogType();
    public static final String NAME = "KHyperLogLog";

    private KHyperLogLogType()
    {
