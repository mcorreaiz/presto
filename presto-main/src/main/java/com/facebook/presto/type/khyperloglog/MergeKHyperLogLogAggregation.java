...
public final class MergeKHyperLogLogAggregation
{
    ...
    @InputFunction
    public static void input(KHyperLogLogState state, @SqlType(KHyperLogLogType.NAME) Slice value)
    {
    ...
    private static void merge(KHyperLogLogState state, KHyperLogLog instance)
    {
